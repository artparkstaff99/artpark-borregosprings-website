...
const cards = [
  ...
  },
  {
    ...
    description:
      "This is a description for Card 2. It can vary in length, sometimes being longer or shorter.",
  },
  {
    id: 3,
    title: "Card Title 3",
  ...
  },
  {
    ...
    description:
      "This is a description for Card 4. Descriptions can have different lengths.",
  },
  {
    id: 5,
    title: "Card Title 5",
    imageUrl: "https://via.placeholder.com/150",
    description:
      "This is a description for Card 5. The amount of text can change.",
  },
];
  ...
  return (
    <div className="flex flex-col justify-center gap-4 p-4">
      {cards.map((card) => (
        ...
        >
          <img
            className="h-[100px] object-contain rounded-t-lg md:rounded-none md:rounded-l-lg"
            src={card.imageUrl}
            alt=""
          />
